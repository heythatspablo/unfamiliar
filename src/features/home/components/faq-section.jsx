    ...
    <section className="py-12 lg:py-24">
      <div className="container mx-auto px-4">
        <header className="text-center mb-20">
          <h1 className="font-heading text-6xl mb-6">Frequently Asked Questions</h1>
          <p className="text-gray-700">Everything you need to know about identity verification.</p>
        </header>
        <div className="max-w-4xl mx-auto">
          ...
          <aside className="sm:flex py-10 px-5 sm:px-10 bg-orange-50 rounded-2xl">
            ...
            <div>
              <h5 className="text-xl font-medium mb-4">Need help getting started?</h5>
              <p className="text-gray-700">
                <span>Our team is ready to help you implement identity verification.</span>{' '}
                <a className="inline-block text-black font-medium underline" href="/contact">Contact us</a>{' '}
                <span>for a personalized demo or technical support.</span>
              </p>
            </div>
          </aside>
        </div>
