        ...
        <div className="container mx-auto px-4">
          <div className="relative flex items-center justify-between">
            <Link className="inline-block" href="/">
              <Image className="h-auto w-[124px]" src="/images/UNFAMILIAR.ID Copy.png" alt="unfamiliar.id Logo" width={429} height={32} />
            </Link>
            <ul className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden md:flex">
              <li className="mr-4 lg:mr-8">
                <Link className="inline-block text-teal-900 hover:text-teal-700 font-medium" href="/products">Products</Link>
              </li>
              <li className="mr-4 lg:mr-8">
                <Link className="inline-block text-teal-900 hover:text-teal-700 font-medium" href="/solutions">Solutions</Link>
              </li>
              <li className="mr-4 lg:mr-8">
                <Link className="inline-block text-teal-900 hover:text-teal-700 font-medium" href="/developers">Developers</Link>
              </li>
              <li className="mr-4 lg:mr-8">
                <Link className="inline-block text-teal-900 hover:text-teal-700 font-medium" href="/pricing">Pricing</Link>
              </li>
              <li>
                <Link className="inline-block text-teal-900 hover:text-teal-700 font-medium" href="/about">About</Link>
              </li>
            </ul>
            <div className="flex items-center justify-end">
              <div className="hidden md:block">
                <div className="hidden md:block">
                  ...
                  <Link className="inline-flex py-2.5 px-4 items-center justify-center text-sm font-medium text-white border border-teal-900 hover:border-black bg-teal-900 hover:bg-black rounded-full transition duration-200" href="/contact">Request Demo</Link>
                </div>
              </div>
              <button
