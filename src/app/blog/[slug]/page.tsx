        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto">
              <h1 className="text-gray-900 text-4xl md:text-5xl mb-8">Resource Not Found</h1>
              <p className="text-gray-600 text-lg mb-8">The resource you&apos;re looking for doesn&apos;t exist or may have been moved.</p>
              <Link
                href="/blog"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <nav className="flex items-center gap-2 text-sm text-gray-600 mb-8">
              ...
              <span>→</span>
              <Link href="/blog" className="hover:text-teal-900 transition-colors">Resources</Link>
              <span>→</span>
            ...
            <div className="flex items-center gap-6 text-gray-600 mb-8">
              <div className="flex items-center gap-3">
                ...
                <span>{post.author?.name || 'unfamiliar.id Team'}</span>
              </div>
              <span>•</span>
              <span>{post.date}</span>
              <span>•</span>
          ...
          <div className="max-w-3xl mx-auto">
              ...
              <div className="text-gray-700 text-lg leading-relaxed space-y-6">
                ...
                {post.content?.proTip && (
                  <div className="bg-lime-50 border border-lime-200 rounded-2xl p-8 my-8">
                    <h3 className="text-teal-900 text-xl font-semibold mb-4">💡 Pro Tip</h3>
            ...
            <div className="bg-gradient-to-r from-teal-900/10 to-lime-500/10 border border-teal-900/20 rounded-2xl p-8 mt-16">
              <div className="text-center">
                <h3 className="text-gray-900 text-2xl font-bold mb-4">Ready to Get Started?</h3>
                <p className="text-gray-700 mb-6">
                  Join hundreds of businesses automating identity verification with unfamiliar.id.
                </p>
                <Link
                  href="/contact"
            ...
            {/* Related Posts */}
            <div className="mt-20">
              <h3 className="text-gray-900 text-2xl font-bold mb-8">Related Resources</h3>
